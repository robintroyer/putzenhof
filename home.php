        ...
        <div id="pc_navigation" class="pc_nav">
          <ul class="dropdown menu" data-dropdown-menu>
            <!-- <div></div> -->
              ...
              <!-- <li class="button navbtn" data-toggle="example-dropdown-1">Der Putzenhof</li> -->



              
              <!-- <li class="button navbtn" data-toggle="example-dropdown-2">Appartements & Preise</li>
              ...
              <!-- <li class="button navbtn" data-toggle="example-dropdown-2">
                <a class="pcnav_a" href="#">Appartements & Preise</a>
          
              </li> -->
              <li>
                <a class="pcnav_a" href="#">Der Putzenhof</a>
                <ul class="menu">
              ...
              <li>
                <a class="pcnav_a" href="#">Region & Aktiv</a>
                <ul class="menu">
              ...
              <li>
                <a class="pcnav_a" href="#">Anfrage</a>
              </li>


<!-- 
              <li class="button navbtn" data-toggle="example-dropdown-3">Region & Aktiv</li>
              ...
              <li class="button navbtn">Anfrage</li> -->
        ...
        <div class="content">
          <div class="cards">
            <div></div>
            <div class="card">
              <img src="./src/images/csm_putzenhof-appartement-03_6de71fe36f.png" alt="Appartements" />
              <div class="card-section">
                <h4>Appartements</h4>
                <p>gediegen Wohnen im Putzenhof</p>
                <img class="arrow" src="./src/images/arrow-right.svg" alt="arrow" />
              </div>
            </div>
            <div></div>
            <div></div>
            <div class="card">
              <img src="./src/images/Screenshot_3.png" alt="Putzenhof" />
              <div class="card-section">
                <h4>Der Putzenhof</h4>
            ...
            <div></div>
            <div class="card">
              <img src="./src/images/Screenshot_1.png" alt="Sommerurlaub" />
              <div class="card-section">
                <h4>Sommerurlaub</h4>
            ...
            <div></div>
            <div class="card">
              <img src="./src/images/Screenshot_2.png" alt="Winter" />
              <div class="card-section">
                <h4>Winter</h4>
        ...
        <footer>
          <div class="upper">
            ...
            <div class="nationalpark">
              ...
              <p>Urlaub inmitten der Hohen Tauern buchen. Fragen Sie unverbindlich an.</p>
              <button>Jetzt anfragen</button>
            </div>
          </div>
          <div class="images">
